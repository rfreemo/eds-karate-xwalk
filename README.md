...
## Environments
- Preview: https://main--eds-kartate-xwalk--rfreemo.aem.page/
- Live: https://main--eds-kartate-xwalk--rfreemo.aem.live/
...
1. Open the `eds-kartate-xwalk` directory in your favorite IDE and start coding :)
